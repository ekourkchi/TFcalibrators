...
#hrs=np.arange(27)-1
#pos=15*hrs
#ax.xaxis.set_major_locator(plt.MultipleLocator(15*2))

#add_plane(ax, color='red', plane='equatorial', projection='ecliptic')
add_plane(p, color='red', plane='equatorial', projection='ecliptic')
